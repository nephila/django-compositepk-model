...
class CpkCollector(Collector):
    def delete(self):
        """
        Override of the original delete method to use CPKQueries.

        This solution sucks, but there is no hook to extend / override the query classes used in the original method.
        """
