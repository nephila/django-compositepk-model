    ...
    def add_q(self, q_object):
        ...
        def transform_q(obj):
            ...
            if isinstance(obj, Q):
                ...
                #  obj[1] is rhs(values)
                #   values are separated in this method.
                        ...
                        if last == "in":
                            if len(names) == 2:
                                ...
                                raise NotSupportedError(
                                    "Not supported multi-column with'in' on relation model : {}".format(obj[0])
                                )
...
class CPkQuerySet(QuerySet):
    ...
    def bulk_update(self, objs, fields, batch_size=None):
        ...
        batches = (objs[i : i + batch_size] for i in range(0, len(objs), batch_size))  # noqa: E203
        updates = []
